...
from modulo_ATV15 import numero
print(numero)
print('***' * 10)

# # **2 - Crie 3 números aleatórios**
from modulo_ATV15 import ramnum
print(ramnum)
print('***' * 10)

# # **3 - Crie um número aleatório entre 10 a 30 utilize o range()**
from modulo_ATV15 import dat
print(dat)
print('***' * 10)
...
from modulo_ATV15 import contagem
contagem()
print('***' * 10)
...
# (use módulo, if, for)
from modulo_ATV15 import pares
pares()
print('***' * 10)
